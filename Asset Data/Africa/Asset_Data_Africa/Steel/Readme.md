...
This dataset provides an asset-level geospatial inventory of **steel production facilities across Africa**.

The dataset includes:

- Plant geolocation (EPSG:4326 – WGS 84)
- Facility type (e.g., Integrated / Secondary steel / Electric Arc Furnace where available)
- Primary fuel used
- Operational status
...
| type | Facility type (e.g., integrated, secondary, EAF) |
| fuel | Primary fuel used |
| region | Administrative region |
| country | Country |
| status | Operational status |
| capacity_tonnes | Crude steel production capacity (tonnes/year) |
| emfpm10 | PM10 emission factor (tonnes pollutant / tonne steel) |
| pm10_t_yr | Annual PM10 emissions (tonnes/year) |
| emfpm25 | PM2.5 emission factor (tonnes pollutant / tonne steel) |
| pm25_t_yr | Annual PM2.5 emissions (tonnes/year) |
| emfso2 | SO2 emission factor (tonnes pollutant / tonne steel) |
| so2_t_yr | Annual SO2 emissions (tonnes/year) |
| emfnox | NOx emission factor (tonnes pollutant / tonne steel) |
...
APAD (2025).
*Steel Plants Emissions Dataset – Africa.*
