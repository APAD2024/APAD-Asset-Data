# **Waste Facilities in the Indo-Gangetic Plain (IGP)**
...
This dataset provides an asset-level geospatial inventory of **waste management facilities across the Indo-Gangetic Plain (IGP)**, covering:
...
- Facility type (e.g., dumpsites, landfills, incineration)
- Primary fuel or waste type
- Operational status
...
| type | Facility type (e.g., dumpsite, landfill, incineration) |
...
APAD (2025).
*Waste Facilities Emissions Dataset – Indo-Gangetic Plain (IGP).*
